...
while [ 0 -eq \$(grep -c FINISHED .$${UUID}_status) ]; do \$COMMAND | sed -e 's/Connection Failed: timed out/waiting for Cisco SSH agent to start.../g' | tee .$${UUID}_status; sleep 30; done
rm .$${UUID}_status
EOL
